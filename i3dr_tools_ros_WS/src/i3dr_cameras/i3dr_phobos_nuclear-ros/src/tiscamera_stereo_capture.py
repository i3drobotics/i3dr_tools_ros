...
first_cam = tiscamera.Camera(
    args.left_serial, 1920, 1080, 30, False, False, "camera_left_raw", "left_camera_node")
if args.right_serial:
    second_cam = tiscamera.Camera(
        args.right_serial, 1920, 1080, 30, False, False, "camera_right_raw", "right_camera_node")
