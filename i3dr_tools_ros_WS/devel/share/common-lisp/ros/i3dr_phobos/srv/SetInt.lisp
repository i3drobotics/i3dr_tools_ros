...
(cl:defmethod cl:initialize-instance :after ((m <SetInt-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetInt-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name i3dr_phobos-srv:<SetInt-request> is deprecated: use i3dr_phobos-srv:SetInt-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetInt-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetInt-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name i3dr_phobos-srv:<SetInt-response> is deprecated: use i3dr_phobos-srv:SetInt-response instead.")))
