...
if("TRUE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/htp/i3dr_tools_ros/i3dr_tools_ros_WS/src/i3dr_cameras/gscam)
  set(gscam_DEVEL_PREFIX /home/htp/i3dr_tools_ros/i3dr_tools_ros_WS/devel/.private/gscam)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /home/htp/i3dr_tools_ros/i3dr_tools_ros_WS/install)
...
if(NOT "/home/htp/i3dr_tools_ros/i3dr_tools_ros_WS/src/i3dr_cameras/gscam/include;/usr/include/gstreamer-1.0;/usr/lib/x86_64-linux-gnu/gstreamer-1.0/include;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include " STREQUAL " ")
  set(gscam_INCLUDE_DIRS "")
  set(_include_dirs "/home/htp/i3dr_tools_ros/i3dr_tools_ros_WS/src/i3dr_cameras/gscam/include;/usr/include/gstreamer-1.0;/usr/lib/x86_64-linux-gnu/gstreamer-1.0/include;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/htp/i3dr_tools_ros/i3dr_tools_ros_WS/src/i3dr_cameras/gscam/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/htp/i3dr_tools_ros/i3dr_tools_ros_WS/devel/.private/gscam/lib;/home/htp/i3dr_tools_ros/i3dr_tools_ros_WS/devel/lib;/opt/ros/kinetic/lib)
