...
(cl:in-package i3dr_stereo_camera-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetFloat-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFloat-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name i3dr_stereo_camera-srv:<SetFloat-request> is deprecated: use i3dr_stereo_camera-srv:SetFloat-request instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SetFloat-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader i3dr_stereo_camera-srv:data-val is deprecated.  Use i3dr_stereo_camera-srv:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetFloat-request>)))
  ...
  "i3dr_stereo_camera/SetFloatRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetFloat-request)))
  "Returns string type for a service object of type 'SetFloat-request"
  "i3dr_stereo_camera/SetFloatRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetFloat-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFloat-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name i3dr_stereo_camera-srv:<SetFloat-response> is deprecated: use i3dr_stereo_camera-srv:SetFloat-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetFloat-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader i3dr_stereo_camera-srv:success-val is deprecated.  Use i3dr_stereo_camera-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <SetFloat-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader i3dr_stereo_camera-srv:message-val is deprecated.  Use i3dr_stereo_camera-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetFloat-response>)))
  ...
  "i3dr_stereo_camera/SetFloatResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetFloat-response)))
  "Returns string type for a service object of type 'SetFloat-response"
  "i3dr_stereo_camera/SetFloatResponse")
